...
class Trainer2 extends StatelessWidget {
  const Trainer2({super.key});
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    // ===== TABS =====
                    // ✅ Beginner jadi KUNING + route pindah ke sini
                    Positioned(
                      left: w(35),
                      top: h(80),
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, AppRoutes.trainer1);
                        },
                        child: Container(
                          width: w(157),
                          height: h(32),
                    ...
                    // ✅ Intermediate jadi PUTIH (tanpa route)
                    Positioned(
                      left: w(202),
                      top: h(80),
                      child: Container(
                      ...
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          image: const DecorationImage(
                            image: AssetImage("assets/images/trainer-21.png"),
                            fit: BoxFit.cover,
                          ),
                          shape: RoundedRectangleBorder(
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        height: h(26),
                        child: Text(
                          'Push Your Limits: 30-Day Fitness Journey',
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: w(17),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          image: const DecorationImage(
                            image: AssetImage("assets/images/trainer-22.png"),
                            fit: BoxFit.cover,
                          ),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(w(20)),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          image: const DecorationImage(
                            image: AssetImage("assets/images/trainer-23.png"),
                            fit: BoxFit.cover,
                          ),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(w(20)),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          image: const DecorationImage(
                            image: AssetImage("assets/images/trainer-24.png"),
                            fit: BoxFit.cover,
                          ),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(w(20)),
